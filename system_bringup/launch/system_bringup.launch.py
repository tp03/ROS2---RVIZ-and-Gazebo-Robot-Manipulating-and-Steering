...
def declare_actions(
    ...
    gazebo = include_scoped_launch_py_description(
        pkg_name='system_bringup',
        paths=['launch', 'our_world.launch.py'],
...
def get_model_paths(packages_names):
    ...
    return model_paths# Copyright (c) 2024 PAL Robotics S.L. All rights reserved.
#
